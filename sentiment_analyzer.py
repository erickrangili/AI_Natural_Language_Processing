...
if __name__=='__main__':
    ...
    # Extract the features from the reviews and label it accordingly
   ...
   # print('\nTop ' + str(N) + ' most informative words:')
    ...
    'I think the costumes were terrible and the characters were very weak',
    'People say that the director of the movie is amazing',
    'People hate your products, they are very boring',
    'This movie was so bad. It wasted my time'
    ]
